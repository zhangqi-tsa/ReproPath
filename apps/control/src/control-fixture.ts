...
<h1>Human Control · 本地交互测试</h1><button id="target">Remote Click Target</button>
...
document.querySelector('#target').onclick = () => { result('remote-click-ok'); fetch('/fixture/api/user?human=1'); };
